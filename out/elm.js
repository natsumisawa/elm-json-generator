...
var author$project$Main$Form = function (text) {
	return {text: text};
};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{
			form: author$project$Main$Form(''),
			jsonText: ''
		},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$convert = function (form) {
	return 'Json.obj( ' + (form.text + ' -> ??? )');
};
		...
		if (msg.$ === 'Input') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						jsonText: author$project$Main$convert(form)
					}),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$Convert = {$: 'Convert'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('json convertor')
							]))
					])),
				A2(
				elm$html$Html$main_,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onClick(author$project$Main$Convert)
									]),
								_List_fromArray(
									[
										elm$html$Html$text('converte')
									]))
							])),
						A2(
						elm$html$Html$article,
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Input":["String.String"],"Convert":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));